...
def upload_image():
    uploaded_file = st.file_uploader("Elige una imagen que contenga solo un Rostro y verificara si tiene un perfil en https://www.proofofhumanity.org/profile/ ....", type=["jpg", "png"])
